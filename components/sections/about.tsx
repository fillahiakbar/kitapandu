    ...
    <section id="about" className="py-28">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mb-20 text-center">
          <span className="mb-4 block text-sm font-bold text-blue-600">
            Tentang kami
          </span>
        ...
        <div className="grid grid-cols-1 items-center gap-16 md:grid-cols-2">
          ...
          {/* TEXT */}
          <div>
            <p className="mb-6 text-[16px] leading-[1.8] text-gray-500">
            ...
            <p className="mb-10 text-[16px] leading-[1.8] text-gray-500">
